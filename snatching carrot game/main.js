...
const gameScroe = document.querySelector('.game__score');
...
function showTimerAndScore() {
    ...
    gameScroe.style.visibility = 'visible';
}
...
function initGame() {
    ...
    score = 0;
    field.innerHTML = '';
    gameScroe.innerText = CARROT_COUNT;
...
function updateScoreBoard() {
    gameScroe.innerText = CARROT_COUNT - score;
}
